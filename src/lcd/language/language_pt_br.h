...
namespace Language_pt_br {
  ...
  PROGMEM Language_Str MSG_FAN_SPEED                       = _UxGT("Vel. Cooler");
  PROGMEM Language_Str MSG_FAN_SPEED_N                     = _UxGT("Vel. Cooler ~");
  PROGMEM Language_Str MSG_EXTRA_FAN_SPEED                 = _UxGT("+Vel. Cooler");
  PROGMEM Language_Str MSG_EXTRA_FAN_SPEED_N               = _UxGT("+Vel. Cooler ~");
  ...
  PROGMEM Language_Str MSG_VE_JERK                         = _UxGT("jerk VE");
  ...
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY_BED             = _UxGT("THERMAL RUNAWAY MESA");
  PROGMEM Language_Str MSG_THERMAL_RUNAWAY_CHAMBER         = _UxGT("THERMAL RUNAWAY CAMARA");
